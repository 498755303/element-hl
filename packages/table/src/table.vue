<template>
  <div class="el-table"
    ...
    <div v-if="showHeader"
         ...
         class="el-table__header-wrapper adesk_table-header"
         ref="headerWrapper">
    ...
    <div class="el-table__body-wrapper"
         ref="bodyWrapper"
         :class="[layout.scrollX ? `is-scrolling-${scrollPosition} scrolling_adesk` : 'is-scrolling-none scrolling_adesk']"
         :style="[bodyHeight]">
    ...
    <div v-if="fixedColumns.length > 0"
      ...
      fixedHeight]">
      <div v-if="showHeader"
           class="el-table__fixed-header-wrapper adesk_table-header"
